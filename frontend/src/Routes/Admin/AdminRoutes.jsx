    ...
    const allSections = [
      ...
      // ACADEMIC MANAGEMENT
      {
        ...
        subTabs: [
          ...
          { title: "Teacher Management", path: "teacher-management" },
          {
            title: "Student Management (Active)",
            path: "student-management",
          },
          { title: "Subject Management", path: "subject-management" },
          { title: "Timetable Management", path: "timetable-management" },
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="leave-requests" element={<LeaveRequests />} />
        <Route
          path="staff-attandance-grid"
          element={<StaffAttendanceGrid />}
        />
        ...
        <Route
          ...
          element={<BookIssueReturn />}
        />

        <Route
          path="library-inventory"
          element={<LibraryInventory />}
        />

        {/* TRANSPORT */}
        <Route
          path="transport-vehicles"
          element={<VehicleManagementTab school={school} />}
        />

        <Route
          path="transport-staff"
          element={<StaffManagementTab school={school} />}
        />

        <Route
          path="transport-fuel"
          element={<FuelLogsTab school={school} />}
        />

        <Route
          path="transport-trips"
          element={<TripLogsTab school={school} />}
        />

        <Route
          path="transport-reports"
          element={<TransportReportsTab school={school} />}
        />
        ...
        <Route
          path="fee-overview"
          element={<FeeOverview school={school} />}
        />
