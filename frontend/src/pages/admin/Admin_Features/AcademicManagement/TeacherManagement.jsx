      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-slate-600 font-medium text-sm  mt-2">
            Manage class teachers & subject assignments
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="pl-9 pr-4 py-2 rounded-lg border border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none w-60"
            />
          </div>
          ...
          <select
            value={academicYear}
            onChange={(e) => setAcademicYear(e.target.value)}
            className="px-4 py-2 rounded-lg border border-slate-300 bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none"
          >
        ...
        <div className="bg-slate-50 rounded-xl border border-slate-200 p-4">
          <div className="flex items-center justify-between">
            <div className="text-sm text-slate-600">
              ...
              of <span className="font-semibold">{totalTeachers}</span> teachers
            </div>
            <div className="text-sm text-slate-600">
              Department:{" "}
...
function TeacherCard({ teacher, onAssignClassTeacher, onAssignSubject }) {
  ...
  return (
    ...
    >
      {/* LEFT IMAGE */}
      <div className="w-28 h-28 rounded-full overflow-hidden bg-slate-200 flex-shrink-0">
        {teacher.profilePicture ? (
          <img
            src={displayPhoto}
            alt={teacher.name}
