...
//   sec => sec.id === selectedSection?.id || sec.sectionName === selectedSection?.sectionName
// );
const selectedSectionData = selectedSection; 
  console.log("Selected Section Data:", selectedSectionData?.classTeacher);
...
<div className="px-6 py-5 border-t border-slate-100">
  ...
  {selectedSectionData?.classTeacher ? (
    <div className="flex items-center justify-between bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-100 rounded-2xl p-4">
      
      <div className="flex items-center gap-4">
        
        {/* Avatar */}
        <div className="h-14 w-14 rounded-2xl bg-indigo-600 text-white flex items-center justify-center text-xl font-bold shadow-md">
          {selectedSectionData?.classTeacher?.name?.charAt(0)}
        </div>

        {/* Teacher Info */}
        <div>
          <h3 className="text-lg font-bold text-slate-800">
            {selectedSectionData.classTeacher.name}
          </h3>

          <p className="text-sm text-slate-500">
            Employee ID: {selectedSectionData.classTeacher.teacherID}
          </p>
      ...
      {/* Badge */}
      <div className="px-4 py-2 bg-emerald-100 text-emerald-700 rounded-xl text-sm font-bold">
        Active Teacher
      </div>
    </div>
  ) : (
