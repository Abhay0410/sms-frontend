...
//     if (parentForm.parentPhone && !phoneRegex.test(parentForm.parentPhone.replace(/\D/g, ''))) {
...
//         parentIncome: parentForm.parentIncome ? Number(parentForm.parentIncome) : undefined,
...
// const finalData = resp.data?.student ? resp.data : (resp.student ? resp : resp.data);

// setCreatedData(finalData); 
// toast.success(resp?.message || "Student and parent registered successfully ✅");
...
//     let msg = err?.response?.data?.message || err?.message || "Failed to register student and parent";
...
//         <div className="mt-6">
//           <h2 className="text-3xl font-bold text-gray-900">Register Student & Parent</h2>
...
//                 <h3 className="mb-6 text-xl font-semibold text-gray-900">Basic Information</h3>
...
//               {/* Address */}
//               <div className="rounded-lg bg-white p-6 shadow-md md:p-8">
//                 <h3 className="mb-6 text-xl font-semibold text-gray-900">Address Details</h3>
...
//               {/* Father's Details */}
//               <div className="rounded-lg bg-white p-6 shadow-md md:p-8">
//                 <h3 className="mb-6 text-xl font-semibold text-gray-900">Father's Details</h3>
...
//               {/* Mother's Details */}
//               <div className="rounded-lg bg-white p-6 shadow-md md:p-8">
//                 <h3 className="mb-6 text-xl font-semibold text-gray-900">Mother's Details (Optional)</h3>
...
//               {/* Guardian Details (Optional) */}
//               <div className="rounded-lg bg-white p-6 shadow-md md:p-8">
//                 <h3 className="mb-6 text-xl font-semibold text-gray-900">Guardian Details (Optional)</h3>
...
//               <div className="rounded-lg bg-white p-6 shadow-md md:p-8">
//                 <h3 className="mb-6 text-xl font-semibold text-gray-900">Academic Information</h3>
...
//                     </select>
//                     <p className="mt-1 text-xs text-gray-500">Current: {getCurrentAcademicYear()}</p>
//                   </div>
...
//               {/* Medical Information */}
//               <div className="rounded-lg bg-white p-6 shadow-md md:p-8">
//                 <h3 className="mb-6 text-xl font-semibold text-gray-900">Medical Information (Optional)</h3>
...
//               {/* Transport & Hostel */}
//               <div className="rounded-lg bg-white p-6 shadow-md md:p-8">
//                 <h3 className="mb-6 text-xl font-semibold text-gray-900">Transport & Hostel (Optional)</h3>
...
//           {activeTab === "parent" && (
//             <div className="rounded-lg bg-white p-6 shadow-md md:p-8">
//               <h3 className="mb-6 text-xl font-semibold text-gray-900">Parent/Guardian Information</h3>
//               <div className="mb-6 rounded-lg bg-blue-50 p-4 border border-blue-200">
//                 <p className="text-sm text-blue-900">
//                   <strong>💡 Note:</strong> If a parent with the same name and email already exists, 
//                   the student will be added as an additional child to that parent account.
//                 </p>
//               </div>
...
//                     <h4 className="mb-3 font-semibold text-gray-900">Student Credentials</h4>
//                     <div className="space-y-2 text-sm text-gray-700">
//                       <div className="flex items-center justify-between">
//                         <span><strong>Student ID:</strong> {createdData.student?.credentials?.studentID || "Not Available"}</span>
// <button
//   type="button"
//   onClick={() =>  copyToClipboard(createdData.student?.credentials?.studentID, "Student ID")}
//                           className="ml-2 text-indigo-600 hover:text-indigo-800"
//                         >
//                           <FaCopy />
//                         </button>
//                       </div>
//                       <p><strong>Name:</strong> {createdData.student?.name}</p>
//                       <p><strong>Class:</strong> {createdData.student?.className || 'Not Assigned'}</p>
//                       <p><strong>Section:</strong> <span className="text-amber-600">Not Assigned Yet</span></p>
//                       <p><strong>Status:</strong> <span className="inline-flex rounded-full bg-yellow-100 px-2 py-0.5 text-xs font-medium text-yellow-800">REGISTERED</span></p>
//                       <div className="mt-3 rounded bg-red-100 p-3">
//                         <div className="flex items-center justify-between">
//                           <span className="font-medium">Password:</span>
//                           <button
//                             type="button"
//                             onClick={() => copyToClipboard(createdData.student?.credentials?.password, "Student Password")}
//                             className="ml-2 text-red-700 hover:text-red-900"
//                           >
//                             <FaCopy />
//                           </button>
//                         </div>
//                         <p className="mt-1 font-mono text-red-700">{createdData.student?.credentials?.password}</p>
//                       </div>
//                     </div>
//                   </div>
...
//                       Parent Credentials
//                       {createdData.isExistingParent && (
//                         <span className="ml-2 text-xs font-normal text-orange-600">(Existing Account)</span>
//                       )}
//                     </h4>
//                     <div className="space-y-2 text-sm text-gray-700">
//                       <div className="flex items-center justify-between">
//                         <span><strong>Parent ID:</strong> {createdData.parent?.credentials?.parentID}</span>
//                         <button
//                           type="button"
//                           onClick={() => copyToClipboard(createdData.parent?.credentials?.parentID, "Parent ID")}
//                           className="ml-2 text-indigo-600 hover:text-indigo-800"
//                         >
//                           <FaCopy />
//                         </button>
//                       </div>
//                       <p><strong>Name:</strong> {createdData.parent?.name}</p>
//                       <p><strong>Email:</strong> {createdData.parent?.email}</p>
//                       <p><strong>Children:</strong> {createdData.parent?.children?.length || 1}</p>
                      
//                       {!createdData.isExistingParent && createdData.parent?.credentials?.password && (
//                         <div className="mt-3 rounded bg-red-100 p-3">
//                           <div className="flex items-center justify-between">
//                             <span className="font-medium">Password:</span>
//                             <button
//                               type="button"
//                               onClick={() => copyToClipboard(createdData.parent?.credentials?.password, "Parent Password")}
//                               className="ml-2 text-red-700 hover:text-red-900"
//                             >
//                               <FaCopy />
//                             </button>
//                           </div>
//                           <p className="mt-1 font-mono text-red-700">{createdData.parent?.credentials?.password}</p>
//                         </div>
//                       )}
...
//                           <p className="text-xs">
//                             ℹ️ This student has been added to an existing parent account. 
//                             The parent can use their existing credentials to login.
//                           </p>
//                         </div>
//                       )}
//                     </div>
...
//                     <li>✅ Student registered in <strong>Class {createdData.student?.className}</strong></li>
//                     <li>⏳ Status: <strong>REGISTERED</strong> (Section not assigned yet)</li>
//                     <li>🎯 Go to <strong>Class Management → Assign Students to Sections</strong></li>
