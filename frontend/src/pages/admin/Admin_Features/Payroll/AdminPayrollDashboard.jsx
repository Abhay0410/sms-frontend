...
//         <div>
//            <h1 className="text-4xl font-bold text-slate-800 tracking-tight">Payroll Command Center</h1>
...
//           <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Paid (Current Month)</p>
//           <h2 className="text-4xl font-bold text-slate-900 mt-2">₹{summary.paid.toLocaleString()}</h2>
//         </div>
...
//           <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Pending Disbursement</p>
//           <h2 className="text-4xl font-bold text-slate-900 mt-2">₹{summary.pending.toLocaleString()}</h2>
//         </div>
...
//           <h2 className="text-4xl font-bold text-slate-900 mt-2">{summary.totalStaff}</h2>
//         </div>
//       </div>
