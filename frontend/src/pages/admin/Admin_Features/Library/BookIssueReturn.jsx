...
export default function BookIssueReturn() {
  ...
  const handleIssue = async (e) => {
    ...
    try {
      ...
      const response = await api.post(
        API_ENDPOINTS.ADMIN.LIBRARY?.ISSUE_BOOK,
        payload,
      );
  ...
  const handleReturn = async (e) => {
    ...
    try {
      const response = await api.post(
        API_ENDPOINTS.ADMIN.LIBRARY?.RETURN_BOOK,
        returnData,
      );
          ...
          <div className="lg:col-span-2 space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative mt-2">
                        ...
                        <input
                          ...
                          className="w-full pl-12 pr-4 py-5 bg-white border border-slate-400 rounded-2xl focus:border-emerald-500 outline-none font-bold text-lg"
                          placeholder="BK-X-000"
                        />
                      </div>
                    </div>
                    <button
                      type="submit"
                      className="w-full py-5 bg-emerald-600 text-white rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-100"
                    >
                      Process Return
                    </button>
                  </form>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <h4 className="mt-4 font-black text-slate-800 tracking-tight">
                  Issued Books List
                </h4>
                <p className="text-xs text-slate-400 font-medium">
                  See who has which book
                </p>
              </button>
                ...
                {recentTransactions.length > 0 ? (
                  recentTransactions.map((t, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className={`p-4 rounded-2xl bg-white shadow-sm border border-slate-400`}
                      >
                        <div className="flex justify-between items-start mb-1">
                          ...
                          <span
                            className={`text-[9px] font-black px-2 py-0.5 rounded-2xl ${actionType === "ISSUE" ? "bg-orange-100 text-orange-600" : "bg-emerald-100 text-emerald-600"}`}
                          >
                            {actionType}
                          </span>
                        </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[85vh] overflow-hidden flex flex-col shadow-2xl">
            <div className="p-8 border-b border-slate-400 flex items-center justify-between">
              ...
              <button
                ...
                className="h-12 w-12 bg-slate-100 rounded-2xl flex items-center justify-center hover:bg-slate-200 transition-all"
              >
                    ...
                    .map((book, idx) => (
                      ...
                      >
                        <td className="py-4 px-2">
                          ...
                          <p className="text-[10px] font-mono text-orange-500 font-bold uppercase">
                            {book.bookCode}
                          </p>
                        </td>
                        <td className="py-4 px-2">
                          <div className="flex items-center gap-2">
                            <div
                              className={`h-7 w-7 rounded-lg flex items-center justify-center text-[10px] font-black uppercase ${book.userType === "teacher" ? "bg-indigo-600 text-white" : "bg-slate-900 text-white"}`}
                            >
                        ...
                        <td className="py-4 px-2">
                          <p
                            className={`text-xs font-bold ${new Date(book.dueDate) < new Date() ? "text-red-500 animate-pulse" : "text-slate-500"}`}
                          >
                            {book.dueDate
