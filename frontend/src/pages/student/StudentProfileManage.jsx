...
//         allergies: Array.isArray(studentData.allergies)
...
//         API_ENDPOINTS.STUDENT.AUTH.PROFILE,
//         formData,
//         {
//           headers: {
...
//                   Your section has not been assigned yet. Please contact the
...
export default function StudentProfileManage() {
  ...
  const loadProfile = async () => {
    try {
      const resp = await api.get(API_ENDPOINTS.STUDENT.AUTH.PROFILE);
      let studentData = resp.student || resp.data || resp;
      if (studentData.student) studentData = studentData.student;
  ...
  const displaySection =
    studentInfo?.section?.sectionName ||
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-white text-center md:text-left flex-1">
              ...
              <div className="space-y-1">
                ...
                <p className="text-blue-100">{studentInfo.email}</p>
                <p className="text-blue-100">
                  Class: {displayClass} {displaySection && `- Sec ${displaySection}`}
                </p>
                {studentInfo.rollNumber && (
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* <div className="rounded-2xl bg-white p-6 shadow-lg border border-gray-100">
              ...
              <p className="text-sm text-slate-500">
                Password change is disabled for student accounts.
              </p>
            </div> */}
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      disabled
                      className="w-full rounded-xl border border-slate-300 p-3 bg-slate-50 text-slate-700 cursor-not-allowed"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    <input
                      ...
                      checked={form.transportRequired}
                      disabled
                      className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 cursor-not-allowed"
                    />
                    <label className="ml-2 text-sm font-medium text-gray-700">
                      Transport Required
                    </label>
