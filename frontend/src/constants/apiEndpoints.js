...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    TEACHER_MANAGEMENT: {
      ...
      GET_SCHEDULE: (id) => `/api/admin/teacher-management/teacher-schedule?teacherId=${id}`,
      ...
      ASSIGN_CLASS_TEACHER:
        "/api/admin/teacher-management/assign-class-teacher",
      ASSIGN_SUBJECT_TEACHER:
        "/api/admin/teacher-management/assign-subject-teacher",
      REMOVE: "/api/admin/teacher-management/remove",
      REMOVE_CLASS_TEACHER:
        "/api/admin/teacher-management/remove-class-teacher",
      REMOVE_SUBJECT_TEACHER:
        "/api/admin/teacher-management/remove-subject-teacher",
    },
    ...
    CLASS: {
      ...
      ASSIGN_STUDENTS: (classId, sectionName) =>
        `/api/admin/classes/${classId}/section/${sectionName}/assign-students`,
    ...
    SUBJECT_MANAGEMENT: {
      ...
      REMOVE_FROM_SECTIONS:
        "/api/admin/subject-management/remove-from-sections",
    },
    ...
    TIMETABLE: {
      ...
      UPDATE_PERIOD: (id, day, periodId) =>
        `/api/admin/timetable/${id}/${day}/period/${periodId}`,
      DELETE_PERIOD: (id, day, periodId) =>
        `/api/admin/timetable/${id}/${day}/period/${periodId}`,
    ...
    FEE: {
      ...
      PAYMENT_HISTORY: (studentId) =>
        `/api/admin/fees/student/${studentId}/history`,
    ...
    ANNOUNCEMENT: {
      ...
      DELETE_ATTACHMENT: (announcementId, attachmentId) =>
        `/api/admin/announcements/${announcementId}/attachment/${attachmentId}`,
    ...
    PAYROLL: {
      ...
      UPDATE_SALARY: (teacherId) =>
        `/api/admin/payroll/teachers/${teacherId}/salary`,

      // ✅ Staff Management
      STAFF_LIST: "/api/admin/payroll/staff-list",

      // ✅ Pre-payroll
      ATTENDANCE_STATS: (month, year) =>
        `/api/admin/payroll/attendance-stats?month=${month}&year=${year}`,
    ...
    LIBRARY: {
      ...
      ACTIVE_ISSUES: "/api/admin/library/active-issues",
  ...
  TEACHER: {
    ...
    MESSAGING: {
      ...
      DELETE_MESSAGE: (threadId, messageId) =>
        `/api/teacher/messages/${threadId}/message/${messageId}`,
    },
    MY_HR: {
