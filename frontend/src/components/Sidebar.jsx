...
//     // ✅ FORCE re-trigger even on same click
//     window.location.hash = "";   // reset first
      ...
      return (
        <div key={tab.title}>
          <button
            ...
            className={`w-full flex items-center justify-between rounded-lg px-4 py-2 text-xs font-bold transition-all ${
              isActive(tab.path) || hasActiveChild
